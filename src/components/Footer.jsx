  ...
  return (
    <footer className="text-center py-3">
      <div className="container">
        <a
          href="https://github.com/milena-allaway"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/milena-wheatcroft-023202281/"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://twitter.com/milena_allaway"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://www.instagram.com/milena_allaway/"
          target="_blank"
          rel="noopener noreferrer"
        >
